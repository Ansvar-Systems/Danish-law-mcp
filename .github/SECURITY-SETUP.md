...
This document describes the secrets and configuration required for the Danish Law Law MCP GitHub Actions workflows.

## Required Secrets

| Secret | Used By | Description |
|--------|---------|-------------|
| `NPM_TOKEN` | `publish.yml` | npm automation token for publishing `@ansvar/danish-law-mcp` |
...
3. Select **Granular Access Token** with:
   - **Packages and scopes**: Read and write, scoped to `@ansvar/danish-law-mcp`
